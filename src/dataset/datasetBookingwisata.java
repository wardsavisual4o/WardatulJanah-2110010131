 ...
 * @author ACER
 */
public class datasetBookingwisata {
    ...
    public void Bookingwisata(String nama, String id_book, String telp,
            String kota_wisata, String harga, String tgl_keb, String book_pkt, String batal ){
        addNama(nama);
        addId_book(id_book);
        addTelp(telp);
